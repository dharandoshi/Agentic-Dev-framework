...
1. **Starting a task:**
   ...
   mcp__monitoring__heartbeat(agent="technical-writer", task_count=<active_tasks>)
   ```
...
### Regular Monitoring
- Send heartbeat every 5 minutes: `mcp__monitoring__heartbeat(agent="technical-writer")`
